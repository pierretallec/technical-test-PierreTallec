  ...
  try {
    ...
    if (req.body.email) {
      ...
      const transporter = nodemailer.createTransport({
        ...
        port: 587,
        auth: {
          user: "alexander99@ethereal.email",
          pass: "zmsaVNyqMZ7DNftXBF",
        },
      });

      // Paramètres pour l'e-mail
      const mailOptions = {
        from: "alexander99@ethereal.email", // Adresse email de l'expéditeur
        to: req.body.email, // Adresse email du destinataire depuis la demande (req)
        subject: "Bienvenu !",
        text: "Vous avez été ajouté dans un projet. Cliquez sur le lien *lien*",
      };
